          ...
          <Card>
            <BlockStack gap="300">
              ...
              <Text as="p" variant="bodyMd" tone="caution">
                ⚠️ 本アプリは、特定商取引法に基づく表記ページ等のひな形作成を補助するツールです。
                生成される文言は一般的なテンプレートであり、その内容の法的な正確性・完全性・最新性、
                および関係法令への適合を保証するものではありません。表示内容が貴店の実際の取引条件・
                事業形態に適合しているかは、お客様の責任においてご確認ください。法改正への自動的な追随は
                保証されません。本アプリの利用または生成物の使用に起因して生じたいかなる損害
                （行政指導・処分、取引上の紛争を含む）についても、当社は法令上許容される範囲で責任を負いません。
