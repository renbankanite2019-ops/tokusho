...
<div class="pp-container">
  ...
  ${
    privacy.collectedItems.includes("payment")
      ? `<p>クレジットカード番号等の決済情報は、決済代行事業者（Shopify Payments 等）が取り扱い、当店ではカード番号等を保持しません。</p>`
      : ""
  }
  ...
  <h2>4. 個人情報の安全管理</h2>
  <p>当店は、個人情報の漏えい・滅失・毀損を防止するため、以下を含む必要かつ適切な安全管理措置を講じ、
  従業者および委託先に対して必要な監督を行います。</p>
  <ul>
    <li>個人情報へのアクセス制限およびアクセス権限の管理</li>
    <li>通信の暗号化（SSL/TLS）等による不正アクセス・漏えいの防止</li>
    <li>個人情報を取り扱う情報システムの管理、および委託先の適切な選定・監督</li>
  </ul>
  ...
  <h2>6. Cookie・アクセス解析・外部送信について</h2>
  ${cookieSection}
  ${
    privacy.usesCookies || privacy.usesAnalytics
      ? `<p>Cookie等の利用に伴い、お客様の端末情報や閲覧情報の一部が、アクセス解析等を提供する外部事業者へ送信される場合があります。送信先・送信される情報・利用目的の詳細をお知りになりたい場合は、下記お問い合わせ窓口までご連絡ください。</p>`
      : ""
  }
