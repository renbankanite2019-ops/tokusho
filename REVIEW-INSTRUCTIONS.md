...
5. Page is live at /pages/tokushoho. On Free it shows a small "Powered by Tokusho" footer.

BILLING (Shopify Managed Pricing — the app does NOT call the Billing API)
6. Open プラン・お支払い → click 「プランを選択・変更する」 → you are redirected to Shopify's hosted plan page.
7. Select a plan and approve. On a development store this is a TEST charge — you are not billed.
   - Basic: removes the footer; enables design + JA/EN labels.
   - Pro: Privacy Policy generator, extra pages (会社概要 / お問い合わせ / 返品ポリシー), one-click "generate all 5 pages".
8. To test Pro end-to-end, select Pro (test charge). Re-publish to see the footer removed; the プライバシーポリシー and 追加ページ menus become usable.
